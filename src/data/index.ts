...
export const meta: SiteMeta = {
  ...
  contactNote: "Open to backend and full-stack roles. Laravel, PHP, MySQL. Available immediately.",
}
...
export const experiences: ExperienceItem[] = [
  {
    ...
    location: 'Islamabad, Pakistan',
    description: 'Delivered client-facing web applications including a Laravel-to-React migration, custom CMS platforms, backend development, and live deployments.',
    ...
    bullets: [
      ...
      { text: 'Implemented client-requested features across Laravel, React.js, and Node.js applications while supporting deployed systems.' },
      { text: 'Developed CMS functionality for OD Sports and Perfect Doors, including content, media, events, and product management.' },
      { text: 'Supported live deployments using cPanel, DNS configuration, SSL setup, and release workflows.' },
    ],
  },
  {
...
export const projects: Project[] = [
  {
    ...
    status: 'Production',
    description: 'Led the migration of the corporate website from Laravel to a modern React + Node.js stack, delivering a custom admin panel and the company\'s first live deployment workflow.',
    tagline: 'Corporate website rebuilt from Laravel to a modern React.js and Node.js stack, featuring a custom admin panel, client-facing contact workflow, and a complete deployment pipeline.',
    taglineShort: 'React Migration · Live Deployment',
    context: 'Creative IT Park · Live production · Laravel + React + Node.js',
    problem: 'The existing website was difficult to maintain, lacked responsive design, and required developer involvement for content updates. The project modernized the platform with a scalable architecture and a custom administration system that enabled the team to manage content independently.',
    myRole: 'Led the migration of the corporate platform while developing backend modules, administration features, content management, contact workflow, and coordinating the first successful live deployment.',
    whatIBuilt: [
...
Deployment issue I hit and fixed:
  ...
  - Fixed by auditing the codebase, replacing incompatible syntax, setting correct storage permissions, and documenting a repeatable deploy checklist used on every project since`,
    ...
    takeaways: 'This project strengthened my understanding of live deployments, environment management, and building maintainable CMS platforms that client teams can operate independently.',
    whereItBreaksDown: '',
  ...
  },
  {
    ...
    status: 'Production',
    description: 'Designed and developed a CMS enabling editors to publish articles, schedule content, automate media processing, and manage sports content without touching code.',
    tagline: 'Designed and developed a CMS layer on top of a live Laravel application, introducing editorial workflows, scheduled publishing, and automated media processing without disrupting existing functionality.',
    ...
    myRole: 'Designed and implemented a complete CMS layer on top of an existing live Laravel application, including editorial workflows, scheduled publishing, automated image processing, and administration features while preserving the existing architecture.',
    whatIBuilt: [
      ...
      'Built an editorial admin panel so the client team can manage all content independently',
...
Media upload pipeline (Intervention Image):
  ...
  Paths stored in article_images with size_label column`,
    ...
    takeaways: 'This project reinforced the importance of understanding an existing codebase before extending it. Careful analysis, consistency with established patterns, and incremental development made it possible to introduce major functionality without affecting live stability.',
    whereItBreaksDown: '',
    engineeringHighlights: [
  ...
  },
  {
    ...
    status: 'Production',
    description: 'Designed and developed a product catalog website and custom CMS for a door manufacturer, allowing the client team to manage products, variants, pricing, and website content independently.',
    tagline: 'Designed and developed a product management platform with a normalized database architecture that eliminated duplicate data and simplified catalog management.',
    taglineShort: 'Product Catalog · Variant Schema',
    context: 'Creative IT Park · Client project · Laravel + Blade',
    problem: 'The client managed a product catalog with multiple size and finish combinations per product. Every price update or content change required contacting a developer to modify the database directly. The existing approach produced significant data duplication, making updates error-prone and time-consuming. The goal was to deliver a self-managed platform that the client team could operate independently.',
    myRole: 'Designed the full database schema before writing any code, separating shared product attributes from variant-specific data. Built the product catalog, variant management system, category relationships, admin panel, and public-facing business website.',
    whatIBuilt: [
      ...
      'Developed a custom admin panel so the client team can manage products, categories, variants, and pricing independently',
...
Result: updating a product description is one UPDATE — not one per variant. Categories use a many-to-many pivot, so a product can appear in multiple categories without duplication.`,
  ...
  },
  {
    ...
    status: 'Production',
    description: 'Supported backend development for a national financial literacy platform by implementing bug fixes, feature enhancements, and SQL Server–based workflows used in a deployed educational system.',
    tagline: 'Contributed to the backend of a live Laravel application for a national financial literacy platform, delivering bug fixes, feature enhancements, and SQL Server–based improvements within an enterprise development workflow.',
    taglineShort: 'Backend Support · SQL Server',
    context: 'NIBAF Pakistan · Live platform · Laravel + SQL Server',
    ...
    myRole: 'Contributed to ongoing maintenance by resolving backend issues, implementing feature enhancements, validating application behaviour, and collaborating with senior developers while adapting Laravel development to SQL Server–based workflows.',
    whatIBuilt: [
...
Debugging workflow I followed on every bug:
  ...
  5. Submit for senior developer review`,
    ...
    takeaways: 'This project strengthened my understanding of maintaining deployed software, working within established codebases, and making safe, incremental improvements under real development workflows.',
    whereItBreaksDown: '',
    engineeringHighlights: [
